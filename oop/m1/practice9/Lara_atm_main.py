...
if choice == "Check Balance":
    ...
    balance = (
        Lara_atm_balance.check_balance(account)
    )
    ...
    if st.button("Deposit Money"):
        ...
        if amount <= 0:
            ...
            success = (
                Lara_atm_deposit.deposit_money(
                    account,
                    amount
                )
            )
    ...
    if st.button("Withdraw Money"):
        ...
        if amount <= 0:
            ...
            success = (
                Lara_atm_withdraw.withdraw_money(
                    account,
                    amount
                )
            )
    ...
    result = (
        Lara_atm_analysis.analyze_transactions()
    )
